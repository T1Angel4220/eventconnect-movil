...
class UserService {
  ...
  async updateProfile(data: UpdateProfileData): Promise<ApiResponse<User>> {
    try {
      const response = await api.put<ApiResponse<User>>('/organizer/profile', data);
      return response.data;
    } catch (error) {
      const message = getErrorMessage(error);
      return {
   ...
   */
  async updateProfileImage(imageUri: string): Promise<ApiResponse<{ profile_image: string }>> {
    try {
  ...
  async deleteProfileImage(): Promise<ApiResponse> {
    try {
      const response = await api.delete<ApiResponse>('/organizer/profile-image');
      return response.data;
    } catch (error) {
      const message = getErrorMessage(error);
      return {
  ...
  async changePassword(data: ChangePasswordData): Promise<ApiResponse> {
    try {
      const response = await api.put<ApiResponse>('/organizer/change-password', data);
      return response.data;
    } catch (error) {
      const message = getErrorMessage(error);
      return {
